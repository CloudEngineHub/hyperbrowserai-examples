...
- For each selected URL:
  - Use **Hyperbrowser MCP** to scrape content (prefer **markdown**).
...
- Save location
- How to invoke it (`/<skill-name>` or auto-trigger)
...
- Serper = discovery only. Hyperbrowser MCP = scraping/extraction only.
